...
if(isset($_POST['login'])){
    $sql=mysqli_query($koneksi,"select * from data_admin where username='$_POST[username]' and password='$_POST[password]'");
    ...
    if($cek > 0){
        ...
        $_SESSION['nama'] = $data['nama_admin'];
         echo "<script>alert('Berhasil Login');window.location.href = 'data_admin.php'</script>";
    }else{
